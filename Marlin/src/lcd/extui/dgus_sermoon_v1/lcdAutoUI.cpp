...
void LcdAutoUISetBedLeveling(bool _en)
{
    if(_en)
    {
        ...
        ExtUI::injectCommands(F("M420 S1"));
...
void LcdAutoUISetTempHotend(int16_t _targetTemp)
{
    ...
    ExtUI::setTargetTemp_celsius(lTargetTemp, ExtUI::E0);
...
void LcdAutoUISetTempHotendBlock(int16_t _targetTemp)
{
    ...
    if(_targetTemp > 0)
    {
        ...
        _targetTemp = ExtUI::getActualTemp_celsius(ExtUI::E0);
...
{
    return ExtUI::getActualTemp_celsius(ExtUI::E0);
...
{
    return ExtUI::getTargetTemp_celsius(ExtUI::E0)
...
void LcdAutoUISetTempBed(int16_t _targetTemp)
{
    ...
    ExtUI::setTargetTemp_celsius(lTargetTemp, ExtUI::H0);
...
void LcdAutoUISetTempBedBlock(int16_t _targetTemp)
{
    ...
    if(_targetTemp > 0)
    {
        ...
        _targetTemp = ExtUI::getActualTemp_celsius(ExtUI::H0);
...
{
    return ExtUI::getActualTemp_celsius(ExtUI::H0);
...
{
    return ExtUI::getTargetTemp_celsius(ExtUI::H0);
...
void LcdAutoUISetFeedrate(int16_t _feedrate)
{
    ...
    ExtUI::setFeedrate_mm_s(_feedrate);
    ExtUI::setFeedrate_percent(_feedrate);
