...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_CREALITY_SERMOON_V1
#endif
 ...
 *
 * :[ 'ORIGIN', 'FYSETC', 'HYPRECY', 'MKS', 'RELOADED', 'IA_CREALITY', 'E3S1PRO', 'SERMOON_V1_CREALITY' ]
 */

//#define DGUS_LCD_UI E3S1PRO
#define DGUS_LCD_UI SERMOON_V1_CREALITY
